  ...
  return (
    <>
      ...
      <ul>
        ...
        <li><span role="img" aria-label="laptop">💻</span><span style={{ color: 'green' }}> Doing final year Capstone Project</span> at <a href='https://yasirzaki.net/'>ComNets Lab, NYUAD</a>: Enhancing Mobile Web Browsing through Real-time Image Super-Resolution.</li>
